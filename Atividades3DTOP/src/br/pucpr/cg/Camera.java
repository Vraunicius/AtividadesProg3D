...
public class Camera {
    ...
    private Vector3f vert = new Vector3f(1,0,0);
    ...
    public Camera strafeUp(float distance){
        Vector3f aux = new Vector3f();
        vert.cross(direction,aux);
        position.add(aux.mul(distance));
        return this;
    }
    public Camera strafeDown(float distance){return strafeUp(distance < 0 ? distance : distance*-1);}
